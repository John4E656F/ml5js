...
var stringToChars = function(e) {
    ...
    Trie = function() {
        ...
        return e.prototype.insert = function(e, n, t) {
            for (var r = this.root, o = stringToChars(e), i = 0; i < o.length; i++) r.children[o[i]] || (r.children[o[i]] = new TrieNode, r.children[o[i]].parent = r, r.children[o[i]].word[0] = r.word[0].concat(o[i])), r = r.children[o[i]], i === o.length - 1 && (r.end = !0, r.word[1] = n, r.word[2] = t)
        }, e.prototype.commonPrefixSearch = function(e) {
            for (var n = [], t = this.root.children[e[0]], r = 0; r < e.length && t; r++) t.end && n.push(t.word), t = t.children[e[r + 1]];
...
var RESERVED_SYMBOLS_COUNT = 6,
    Tokenizer = function() {
        function e(e, n) {
            void 0 === n && (n = RESERVED_SYMBOLS_COUNT), this.vocabulary = e, this.reservedSymbolsCount = n, this.trie = new Trie;
        ...
        return e.prototype.encode = function(e) {
            var n = [],
                ...
                r = [];
            e = processInput(e);
            for (var o = stringToChars(e), i = 0; i <= o.length; i++) n.push({}), t.push(0), r.push(0);
            for (i = 0; i < o.length; i++)
                for (var a = this.trie.commonPrefixSearch(o.slice(i)), s = 0; s < a.length; s++) {
                    var u = a[s],
                        l = {
                            key: u[0],
                            score: u[1],
...
var version = "1.3.3",
    BASE_PATH = "https://tfhub.dev/google/tfjs-model/universal-sentence-encoder-qa-ondevice/1",
    SKIP_VALUES = [0, 1, 2],
    OFFSET = 3,
    INPUT_LIMIT = 192,
    QUERY_NODE_NAME = "input_inp_text",
    RESPONSE_CONTEXT_NODE_NAME = "input_res_context",
    RESPONSE_NODE_NAME = "input_res_text",
    RESPONSE_RESULT_NODE_NAME = "Final/EncodeResult/mul",
    QUERY_RESULT_NODE_NAME = "Final/EncodeQuery/mul",
    RESERVED_SYMBOLS_COUNT$1 = 3,
    TOKEN_PADDING = 2,
    TOKEN_START_VALUE = 1;
        ...
        return e.prototype.loadModel = function() {
            return __awaiter(this, void 0, void 0, function() {
                return __generator(this, function(e) {
                    return [2, loadGraphModel(BASE_PATH, {
                        fromTFHub: !0
                    })]
                })
            })
            ...
            return __awaiter(this, void 0, void 0, function() {
                ...
                return __generator(this, function(r) {
                    switch (r.label) {
                        ...
                        case 1:
                            return e = r.sent(), n = e[0], t = e[1], this.model = n, this.tokenizer = new Tokenizer(t, RESERVED_SYMBOLS_COUNT$1), [2]
                    }
                })
            })
            ...
            var n = this,
                t = tidy(function() {
                    var t = n.tokenizeStrings(e.queries, INPUT_LIMIT),
                        r = n.tokenizeStrings(e.responses, INPUT_LIMIT);
                    ...
                    var i = n.tokenizeStrings(o, INPUT_LIMIT),
                        a = {};
                    return a[QUERY_NODE_NAME] = t, a[RESPONSE_NODE_NAME] = r, a[RESPONSE_CONTEXT_NODE_NAME] = i, n.model.execute(a, [QUERY_RESULT_NODE_NAME, RESPONSE_RESULT_NODE_NAME])
                });
            return {
                queryEmbedding: t[0],
            ...
            var t = this,
                r = e.map(function(e) {
                    return t.shiftTokens(t.tokenizer.encode(e), INPUT_LIMIT)
                });
            return tensor2d(r, [e.length, INPUT_LIMIT], "int32")
        }, e.prototype.shiftTokens = function(e, n) {
            e.unshift(TOKEN_START_VALUE);
            for (var t = 0; t < n; t++) t >= e.length ? e[t] = TOKEN_PADDING : SKIP_VALUES.includes(e[t]) || (e[t] += OFFSET);
            return e.slice(0, n)
        }, e
    }(),
...
var UniversalSentenceEncoder = function() {
    ...
    return e.prototype.loadModel = function(e) {
        return __awaiter(this, void 0, void 0, function() {
            return __generator(this, function(n) {
                return [2, e ? loadGraphModel(e) : loadGraphModel("https://tfhub.dev/tensorflow/tfjs-model/universal-sentence-encoder-lite/1/default/1", {
                    fromTFHub: !0
                })]
            })
        })
        ...
        return void 0 === e && (e = {}), __awaiter(this, void 0, void 0, function() {
            ...
            return __generator(this, function(o) {
                switch (o.label) {
                    case 0:
                        return [4, Promise.all([this.loadModel(e.modelUrl), loadVocabulary(e.vocabUrl || BASE_PATH$1 + "/vocab.json")])];
                    case 1:
                ...
                switch (c.label) {
                    case 0:
                        for ("string" == typeof e && (e = [e]), n = e.map(function(e) {
                                return l.tokenizer.encode(e)
                            }), t = n.map(function(e, n) {
                                return e.map(function(e, t) {
                                    return [n, t]
                                })
                            }), r = [], o = 0; o < t.length; o++) r = r.concat(t[o]);
                        return i = tensor2d(r, [r.length, 2], "int32"), a = tensor1d(util.flatten(n), "int32"), s = {
                            indices: i,
                            values: a
