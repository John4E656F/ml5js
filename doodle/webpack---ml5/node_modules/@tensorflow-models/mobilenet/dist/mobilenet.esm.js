        ...
        return __generator(this, function(l) {
            switch (l.label) {
                case 0:
                    ...
                    if (r = e.version.toFixed(2), o = e.alpha ? e.alpha.toFixed(2) : "", i = -1, t = 1, null == e.modelUrl) {
                        if (!(r in MODEL_INFO)) throw new Error("Invalid version of MobileNet. Valid versions are: " + Object.keys(MODEL_INFO));
                        if (!(o in MODEL_INFO[r])) throw new Error("MobileNet constructed with invalid alpha " + e.alpha + ". Valid multipliers for this version are: " + Object.keys(MODEL_INFO[r]) + ".");
                        a = MODEL_INFO[r][o].inputRange, i = a[0], t = a[1]
                    }
                    return [4, (n = new MobileNetImpl(r, o, e.modelUrl, i, t)).load()];
                case 1:
                    return l.sent(), [2, n]
            }
        })
...
var MobileNetImpl = function() {
    function e(e, a, r, o, i) {
        void 0 === o && (o = -1), void 0 === i && (i = 1), this.version = e, this.alpha = a, this.modelUrl = r, this.inputMin = o, this.inputMax = i, this.inputRange = i - o
    }
    return e.prototype.load = function() {
        return __awaiter(this, void 0, void 0, function() {
            ...
            return __generator(this, function(t) {
                switch (t.label) {
                    case 0:
                        return this.modelUrl ? (e = this, [4, loadGraphModel(this.modelUrl)]) : [3, 2];
                    case 1:
                        return e.model = t.sent(), [3, 4];
                    case 2:
                        return a = MODEL_INFO[this.version][this.alpha].url, r = this, [4, loadGraphModel(a, {
                            fromTFHub: !0
                        })];
                    case 3:
        ...
        return void 0 === a && (a = !1), tidy(function() {
            e instanceof Tensor || (e = browser.fromPixels(e));
            var o = e.toFloat().mul(r.inputRange).add(r.inputMin),
                i = o;
            if (e.shape[0] !== IMAGE_SIZE || e.shape[1] !== IMAGE_SIZE) {
                i = image.resizeBilinear(o, [IMAGE_SIZE, IMAGE_SIZE], !0)
            }
            var t, n = i.reshape([-1, IMAGE_SIZE, IMAGE_SIZE, 3]);
            if (a) {
