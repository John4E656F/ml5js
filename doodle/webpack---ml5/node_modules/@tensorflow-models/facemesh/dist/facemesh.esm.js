...
function flipFaceHorizontal(e, t) {
    ...
    if (e.topLeft instanceof Tensor && e.bottomRight instanceof Tensor) {
        ...
        const [i, r] = e.topLeft, [a, c] = e.bottomRight;
...
class BlazeFaceModel {
    ...
    async estimateFaces(e, t = !1, s = !1, o = !0) {
        const [, n] = getInputTensorDimensions(e), i = tidy(() => (e instanceof Tensor || (e = browser.fromPixels(e)), e.toFloat().expandDims(0))), {
            boxes: r,
            scaleFactor: a
        ...
        return i.dispose(), t ? r.map(e => {
            ...
            let i;
            if (o) {
                const [s, o, n] = await Promise.all([e.landmarks, t, e.probability].map(async e => e.array())), r = e.anchor, [c, l] = a, d = s.map(e => [(e[0] + r[0]) * c, (e[1] + r[1]) * l]);
                i = {
                    topLeft: o.slice(0, 2),
...
class Pipeline {
    ...
    updateRegionsOfInterest(e) {
        for (let t = 0; t < e.length; t++) {
            ...
            let n = 0;
            if (o && o.startPoint) {
                const [e, t, i, r] = s.startEndTensor.arraySync()[0], [a, c, l, d] = o.startEndTensor.arraySync()[0], h = Math.max(e, a), u = Math.max(t, c), p = (Math.min(i, l) - h) * (Math.min(r, d) - u);
...
class FaceMesh {
    ...
    async estimateFaces(e, t = !1, s = !1) {
        const [, o] = getInputTensorDimensions$1(e), n = tidy(() => (e instanceof Tensor || (e = browser.fromPixels(e)), e.toFloat().expandDims(0))), i = env().get("WEBGL_PACK_DEPTHWISECONV");
