    ...
    return __awaiter(this, void 0, void 0, function() {
        return __generator(this, function(t) {
            return [2, new Promise(function(t, r) {
                if (0 === e.indexOf("http://") || 0 === e.indexOf("https://")) fetch(e).then(function(e) {
                    e.json().then(function(e) {
                        return t(e)
                    })
                });
                else if (0 === e.indexOf("file://")) {
                    require("fs").readFile(e.slice("file://".length), {
                        encoding: "utf-8"
                    }, function(e, r) {
                        return t(JSON.parse(r))
                    })
                } else r(new Error("Unsupported URL scheme in metadata URL: " + e + ". Supported schemes are: http://, https://, and (node.js-only) file://"))
            })]
        })
    })
}
...
function normalize(e) {
    return null == EPSILON && (EPSILON = backend().epsilon()), tidy(function() {
        var t = moments(e),
            r = t.mean,
            n = t.variance;
        return e.sub(r).div(n.sqrt().add(EPSILON))
    })
}
...
function balancedTrainValSplit(e, t, r) {
    return util.assert(r > 0 && r < 1, function() {
        ...
        for (var n = t.argMax(-1).dataSync(), a = [], i = 0; i < n.length; ++i) {
            var o = n[i];
        ...
        for (i = 0; i < s; ++i)
            for (var c = a[i], h = Math.round(c.length * (1 - r)), d = 0; d < c.length; ++d) d < h ? l.push(c[d]) : u.push(c[d]);
        return {
            trainXs: gather(e, l),
            trainYs: gather(t, l),
            valXs: gather(e, u),
...
function balancedTrainValSplitNumArrays(e, t, r) {
    ...
    for (f = 0; f < g; ++f)
        for (var w = p[f], b = Math.round(w.length * (1 - r)), _ = 0; _ < w.length; ++_) _ < b ? v.push(w[_]) : y.push(w[_]);
    if (h) {
        var S = [],
            x = [],
            E = [],
        ...
        try {
            for (var F = __values(y), M = F.next(); !M.done; M = F.next()) {
                D = M.value;
    ...
    S = [], x = [], E = [], A = [];
    try {
        for (var O = __values(v), R = O.next(); !R.done; R = O.next()) {
            D = R.value;
            S.push(e[D]), x.push(t[D])
        }
    } catch (e) {
    ...
    try {
        for (var z = __values(y), L = z.next(); !L.done; L = z.next()) {
            D = L.value;
            E.push(e[D]), A.push(t[D])
        }
    } catch (e) {
    ...
    Dataset = function() {
        function e(e) {
            if (this.examples = {}, this.label2Ids = {}, null != e)
                for (var t = arrayBuffer2SerializedExamples(e), r = 0, n = 0; n < t.manifest.length; ++n) {
                    var a = t.manifest[n],
            ...
            try {
                for (var o = __values(i), s = o.next(); !s.done; s = o.next()) {
                    var l = s.value,
                        u = e.getExamples(l);
                    try {
                        for (var c = __values(u), h = c.next(); !h.done; h = c.next()) {
                            var d = h.value;
            ...
            return tidy(function() {
                for (var o, l, u, c = [], h = [], d = [], p = 0; p < n.length; ++p) {
                    ...
                    if (null == e || f === e) {
                        var m = r.label2Ids[f],
                            g = function(n) {
                                var o, l, m = r.examples[n].spectrogram,
                                    g = m.frameSize;
                                ...
                                var w = tensor3d(m.data, [v, g, 1]),
                                    ...
                                    _ = function(r) {
                                        var n = tidy(function() {
                                            var e = w.slice([r[0], 0, 0], [r[1] - r[0], -1, -1]);
                        ...
                        try {
                            for (var v = __values(m), y = v.next(); !y.done; y = v.next()) {
                                g(y.value)
                            }
                        } catch (e) {
                            o = {
                ...
                if (t.getDataset) {
                    ...
                    var x = S.map(function(e) {
                        ...
                        E = balancedTrainValSplitNumArrays(h, x, _),
                        A = E.trainXs,
                        T = E.trainYs,
                        I = E.valXs,
                        D = E.valYs,
                        F = data.array(A).map(function(e) {
                            return tensor3d(e, [a, u, 1])
                        }),
                        M = data.array(T).map(function(e) {
                            return oneHot([e], n.length).squeeze([0])
                        }),
                        O = data.zip({
                            xs: F,
                            ys: M
                        });
                    w && (O = O.shuffle(h.length)), O = O.batch(b).prefetch(4);
                    var R = data.array(I).map(function(e) {
                            return tensor3d(e, [a, u, 1])
                        }),
                        z = data.array(D).map(function(e) {
                            return oneHot([e], n.length).squeeze([0])
                        }),
                        L = data.zip({
                            xs: R,
                    ...
                    return [O, L = L.batch(b).prefetch(4)]
                }
                if (w) {
                    var N = [];
                ...
                var C = null == e ? oneHot(tensor1d(d, "int32"), n.length).asType("float32") : void 0;
                return {
                    xs: stack(c),
                    ys: C
                }
            ...
            var c = [],
                ...
                d = function(n) {
                    var a = s[getRandomInteger(0, s.length)],
                        ...
                        u = tidy(function() {
                            return normalize(o.add(l.mul(r)))
                        });
            ...
            try {
                for (var l = __values(i), u = l.next(); !u.done; u = l.next()) {
                    ...
                    if (null == e || -1 !== e.indexOf(c)) {
                        ...
                        try {
                            for (var d = __values(h), p = d.next(); !p.done; p = d.next()) {
                                var f = p.value,
...
function spectrogram2IntensityCurve(e) {
    return tidy(function() {
        ...
        return tensor2d(e.data, [t, e.frameSize]).mean(-1)
    })
}

function getMaxIntensityFrameIndex(e) {
    return tidy(function() {
        return spectrogram2IntensityCurve(e).argMax()
    })
}
var version = "0.3.9",
                            ...
                            return a = null == t.overlapFactor ? .5 : t.overlapFactor, util.assert(a >= 0 && a < 1, function() {
                                ...
                                return __awaiter(s, void 0, void 0, function() {
                                    ...
                                    return __generator(this, function(g) {
                                        switch (g.label) {
                                            case 0:
                                                return o = normalize(a), t.includeEmbedding ? [4, this.ensureModelWithEmbeddingOutputCreated()] : [3, 2];
                                            case 1:
                                                return g.sent(), i = __read(this.modelWithEmbeddingOutput.predict(o), 2), s = i[0], l = i[1], [3, 3];
                                            case 2:
                                                s = this.model.predict(o), g.label = 3;
                                            case 3:
                                                return [4, s.data()];
                                            case 4:
                                                return u = g.sent(), [4, (c = s.argMax(-1)).data()];
                                            case 5:
                                                return h = g.sent()[0], d = Math.max.apply(Math, __spread(u)), dispose([s, c, o]), d < r ? [2, !1] : [3, 6];
                                            case 6:
                                                return p = void 0, t.includeSpectrogram ? (f = {}, [4, a.data()]) : [3, 8];
                                            case 7:
                                                f.data = g.sent(), f.frameSize = this.nonBatchInputShape[1], p = f, g.label = 8;
                                            case 8:
                                                return m = !0, n || this.words[h] !== BACKGROUND_NOISE_TAG && this.words[h] !== UNKNOWN_TAG || (m = !1), m && e({
                                                    scores: u,
                                                    spectrogram: p,
                                                    embedding: l
                                                }), [2, m]
            ...
            return __awaiter(this, void 0, void 0, function() {
                ...
                return __generator(this, function(m) {
                    switch (m.label) {
                        ...
                        case 3:
                            if (e instanceof Tensor) this.checkInputTensorShape(e), a = e, n = e.shape[0];
                            else {
                        ...
                        o.audioDataExtractor = new BrowserFftFeatureExtractor({
                            ...
                            spectrogramCallback: function(r, a) {
                                return __awaiter(o, void 0, void 0, function() {
                                    var i, o, s, d, p, f, m, g, v, y, w, b, _, S, x, E, A, T, I, D;
                                    return __generator(this, function(F) {
                                        switch (F.label) {
                                            ...
                                            case 9:
                                                return F.sent(), this.streaming = !1, this.collateTransferWords(), S = normalizeFloat32Array(concatenateFloat32Arrays(h)), x = {
                                                    data: S,
                                                    frameSize: this.nonBatchInputShape[1]
                                                }, A = (E = this.dataset).addExample, T = {
                                                    label: e,
                                                    spectrogram: x
                                            ...
                                            case 11:
                                                I = void 0, F.label = 12;
                                            case 12:
                                                A.apply(E, [(T.rawAudio = I, T)]), n(x), F.label = 13;
                                            case 13:
                                                return [2, !1]
                                        }
                                    })
                    ...
                    switch (n.label) {
                        case 0:
                            return util.assert(null != this.words && this.words.length > 0, function() {
                                ...
                                metrics: ["acc"]
                            }), t = null == e.fitDatasetDurationMillisThreshold ? 6e4 : e.fitDatasetDurationMillisThreshold, this.dataset.durationMillis() > t ? (console.log("Detected large dataset: total duration = " + this.dataset.durationMillis() + " ms > " + t + " ms. Training transfer model using fitDataset() instead of fit()"), [4, this.trainOnDataset(e)]) : [3, 2];
                        case 1:
                            return [2, n.sent()];
                        case 2:
            ...
            return __awaiter(this, void 0, void 0, function() {
                ...
                return __generator(this, function(n) {
                    return util.assert(null != e.wordProbThresholds && e.wordProbThresholds.length > 0, function() {
                        ...
                        for (var n = [], a = 0, i = r.collectTransferDataAsTensors(e.windowHopRatio), o = i.xs, s = i.ys.argMax(-1).dataSync(), l = r.model.predict(o), u = l.slice([0, 1], [l.shape[0], l.shape[1] - 1]).max(-1), c = l.shape[0], h = 0; h < e.wordProbThresholds.length; ++h) {
