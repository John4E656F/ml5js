...
export function assembleLabelTitle(facetFieldDef, channel, config) {
    const {
        ...
        labelOrient,
        labelExpr
    } = getHeaderProperties(['format', 'formatType', 'labelAngle', 'labelAnchor', 'labelOrient', 'labelExpr'], facetFieldDef, config, channel);
...
export function assembleHeaderGroup(model, channel, headerType, layoutHeader, headerComponent) {
    if (headerComponent) {
        ...
        if (facetFieldDef && headerComponent.labels) {
            const {
                labelOrient
            } = getHeaderProperties(['labelOrient'], facetFieldDef, config, channel);
