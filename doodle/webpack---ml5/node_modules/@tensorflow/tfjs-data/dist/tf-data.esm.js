                ...
                return __generator(this, function(s) {
                    switch (s.label) {
                        ...
                        case 1:
                            ...
                            for (e = tensor_util.getTensorsInContainer(t.value), r = this.transform(t.value), n = tensor_util.getTensorsInContainer(r), i = 0, o = e; i < o.length; i++) a = o[i], tensor_util.isTensorInList(a, n) || a.dispose();
                            return [2, {
                                value: r,
                                done: !1
                            }]
            ...
            return __awaiter(this, void 0, void 0, function() {
                ...
                return __generator(this, function(s) {
                    switch (s.label) {
                        ...
                        case 2:
                            for (r = s.sent(), n = tensor_util.getTensorsInContainer(r), i = 0, o = e; i < o.length; i++) a = o[i], tensor_util.isTensorInList(a, n) || a.dispose();
                            return [2, {
                                value: r,
                                done: !1
                            }]
                ...
                return __generator(this, function(s) {
                    switch (s.label) {
                        ...
                        case 1:
                            ...
                            for (e = tensor_util.getTensorsInContainer(t.value), r = this.transform(t.value), n = tensor_util.getTensorsInContainer(r), this.outputQueue.pushAll(r), i = 0, o = e; i < o.length; i++) a = o[i], tensor_util.isTensorInList(a, n) || a.dispose();
                            return [2, !0]
                    }
                })
            })
...
function zip(t) {
    ...
    if (Array.isArray(t))
        for (var n = 0; n < t.length; n++) e = null == e ? t[n].size : Math.min(e, t[n].size);
...
var TextLineDataset = function(t) {
                    ...
                    switch (s.label) {
                        ...
                        case 1:
                            ...
                            if (this.fullColumnNames && t && util.assert(t.length === this.fullColumnNames.length, function() {
                                ...
                                for (n = 0, i = Object.keys(this.columnConfigs); n < i.length; n++)
    ...
    WebcamIterator = function(t) {
        function e(e, r) {
            ...
            if (n.webcamVideoElement = e, n.webcamConfig = r, n.isClosed = !0, n.resize = !1, n.needToResize())
                if (n.resize = !0, n.cropSize = [n.webcamConfig.resizeHeight, n.webcamConfig.resizeWidth], n.cropBoxInd = tensor1d([0], "int32"), n.webcamConfig.centerCrop) {
        ...
        return __extends(e, t), e.prototype.summary = function() {
            ...
            var e = this;
            return tidy(function() {
                var r, n = t.toFloat().expandDims(0),
    ...
    Utf8IteratorImpl = function(t) {
        function e(e) {
            var r = t.call(this) || this;
            if (r.upstream = e, env().get("IS_BROWSER")) r.decoder = new TextDecoder("utf-8");
            else {
                    ...
                    switch (n.label) {
                        case 0:
                            return this.offset >= (this.file instanceof Uint8Array ? this.file.byteLength : this.file.size) ? [2, {
                                ...
                                if (r.file instanceof Uint8Array) t(new Uint8Array(r.file.slice(r.offset, n)));
                                else {
