...
function where_(condition, a, b) {
    ...
    if ($condition.rank === 1) {
        ...
        // condition.
        util_1.assert($condition.shape[0] === $a.shape[0], function() {
    ...
    var grad = function(dy, saved) {
        ...
        return {
            $condition: function() {
                return tensor_ops_1.zerosLike($condition).toFloat();
            },
            $a: function() {
                return dy.mul($condition.cast(dy.dtype));
            },
            $b: function() {
                return dy.mul($condition.logicalNot().cast(dy.dtype));
            }
        };
    };
...
exports.logicalAnd = operation_1.op({
    logicalAnd_: logicalAnd_
});
exports.logicalNot = operation_1.op({
    logicalNot_: logicalNot_
});
exports.logicalOr = operation_1.op({
    logicalOr_: logicalOr_
});
exports.logicalXor = operation_1.op({
    logicalXor_: logicalXor_
});
exports.where = operation_1.op({
    where_: where_
});
