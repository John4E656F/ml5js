...
function ceil_(x) {
    ...
    var grad = function(dy) {
        return {
            $x: function() {
                return tensor_ops_1.zerosLike(dy);
            }
        };
    };
    return engine_1.ENGINE.runKernelFunc(function(backend) {
...
function sqrt_(x) {
    ...
    var grad = function(dy, saved) {
        ...
        return {
            $x: function() {
                return dy.div($x.toFloat().sqrt().mul(2));
            }
        };
    };
    return engine_1.ENGINE.runKernelFunc(function(backend, save) {
...
function rsqrt_(x) {
    ...
    var grad = function(dy, saved) {
        ...
        return {
            x: function() {
                return dy.div($x.pow(1.5).mul(2)).neg();
            }
        };
    };
    var inputsToSave = [$x];
...
function clipByValue_(x, clipValueMin, clipValueMax) {
    ...
    var grad = function(dy, saved) {
        ...
        return {
            x: function() {
                return dy.where($x.greaterEqual(clipValueMin)
...
function sigmoid_(x) {
    ...
    var grad = function(dy, saved) {
        ...
        return {
            x: function() {
                return dy.mul(y.mul(tensor_ops_1.scalar(1).sub(y)));
            }
        };
    };
    return engine_1.ENGINE.runKernelFunc(function(backend, save) {
...
function asin_(x) {
    ...
    var grad = function(dy, saved) {
        ...
        return {
            $x: function() {
                return dy.divStrict(tensor_ops_1.scalar(1).sub($x.toFloat().square()).sqrt());
            }
        };
    };
    return engine_1.ENGINE.runKernelFunc(function(backend, save) {
...
function atan_(x) {
    ...
    var grad = function(dy, saved) {
        ...
        return {
            $x: function() {
                return dy.div($x.toFloat().square().add(1));
            }
        };
    };
    return engine_1.ENGINE.runKernelFunc(function(backend, save) {
...
function tanh_(x) {
    ...
    var grad = function(dy, saved) {
        ...
        return {
            x: function() {
                return tensor_ops_1.scalar(1).sub(y.square()).mulStrict(dy);
            }
        };
    };
    var outputsToSave = [true];
    return engine_1.ENGINE.runKernelFunc(function(backend, save) {
        ...
        x: $x
    }, grad, 'Tanh', {} /* attrs */ , null /* inputsToSave */ , outputsToSave);
}
/**
...
function asinh_(x) {
    ...
    var grad = function(dy, saved) {
        ...
        return {
            $x: function() {
                return dy.divStrict(tensor_ops_1.scalar(1).add($x.toFloat().square()).sqrt());
            }
        };
    };
    return engine_1.ENGINE.runKernelFunc(function(backend, save) {
...
function acosh_(x) {
    ...
    var grad = function(dy, saved) {
        ...
        return {
            $x: function() {
                return dy.divStrict($x.toFloat().square().sub(1).sqrt());
            }
        };
    };
    return engine_1.ENGINE.runKernelFunc(function(backend, save) {
...
function atanh_(x) {
    ...
    var grad = function(dy, saved) {
        ...
        return {
            $x: function() {
                return dy.div(tensor_ops_1.scalar(1).sub($x.toFloat().square()));
            }
        };
    };
    return engine_1.ENGINE.runKernelFunc(function(backend, save) {
...
function erf_(x) {
    ...
    var grad = function(dy, saved) {
        ...
        return {
            $x: function() {
                return dy.mul($x.square().neg().exp().mul(2 / Math.sqrt(Math.PI)));
            }
        };
    };
    return engine_1.ENGINE.runKernelFunc(function(backend, save) {
...
exports.abs = operation_1.op({
    abs_: abs_
});
exports.acos = operation_1.op({
    acos_: acos_
});
exports.acosh = operation_1.op({
    acosh_: acosh_
});
exports.asin = operation_1.op({
    asin_: asin_
});
exports.asinh = operation_1.op({
    asinh_: asinh_
});
exports.atan = operation_1.op({
    atan_: atan_
});
exports.atanh = operation_1.op({
    atanh_: atanh_
});
exports.ceil = operation_1.op({
    ceil_: ceil_
});
exports.clipByValue = operation_1.op({
    clipByValue_: clipByValue_
});
exports.cos = operation_1.op({
    cos_: cos_
});
exports.cosh = operation_1.op({
    cosh_: cosh_
});
exports.erf = operation_1.op({
    erf_: erf_
});
exports.exp = operation_1.op({
    exp_: exp_
});
exports.expm1 = operation_1.op({
    expm1_: expm1_
});
exports.floor = operation_1.op({
    floor_: floor_
});
exports.log = operation_1.op({
    log_: log_
});
exports.log1p = operation_1.op({
    log1p_: log1p_
});
exports.logSigmoid = operation_1.op({
    logSigmoid_: logSigmoid_
});
exports.neg = operation_1.op({
    neg_: neg_
});
exports.reciprocal = operation_1.op({
    reciprocal_: reciprocal_
});
exports.round = operation_1.op({
    round_: round_
});
exports.rsqrt = operation_1.op({
    rsqrt_: rsqrt_
});
exports.sigmoid = operation_1.op({
    sigmoid_: sigmoid_
});
exports.sign = operation_1.op({
    sign_: sign_
});
exports.isNaN = operation_1.op({
    isNaN_: isNaN_
});
exports.isInf = operation_1.op({
    isInf_: isInf_
});
exports.isFinite = operation_1.op({
    isFinite_: isFinite_
});
exports.sin = operation_1.op({
    sin_: sin_
});
exports.sinh = operation_1.op({
    sinh_: sinh_
});
exports.softplus = operation_1.op({
    softplus_: softplus_
});
exports.sqrt = operation_1.op({
    sqrt_: sqrt_
});
exports.step = operation_1.op({
    step_: step_
});
exports.tan = operation_1.op({
    tan_: tan_
});
exports.tanh = operation_1.op({
    tanh_: tanh_
});
