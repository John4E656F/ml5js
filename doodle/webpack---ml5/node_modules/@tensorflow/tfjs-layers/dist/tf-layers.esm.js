                    ...
                    switch (u.label) {
                        case 0:
                            for (r in e = [], t = [], n = [], this.history)
                                for (i = this.history[r], a = 0; a < i.length; ++a) "number" != typeof i[a] && (o = i[a], e.push(o.data()), t.push(r), n.push(a));
...
function printSummary(e, t, n, r) {
    ...
    var i, a = isModelSequentialLike(e),
        o = ["Layer (type)", "Output shape", "Param #"];
    if (a ? (t = t || 65, n = n || [.45, .85, 1]) : (t = t || 98, n = n || [.33, .55, .67, 1]), n[n.length - 1] <= 1 && (n = n.map(function(e) {
            return Math.floor(t * e)
        })), !a)
        for (var s in o.push("Receives inputs"), i = [], e.nodesByDepth) i.push.apply(i, e.nodesByDepth[s]);
...
function isModelSequentialLike(e) {
    ...
    if (t)
        for (var l = 0, u = e.layers; l < u.length; l++) {
...
function printLayerSummaryWithConnections(e, t, n, r) {
    ...
    for (var a = [], o = 0, s = e.inboundNodes; o < s.length; o++) {
        ...
        if (!(null != n && n.length > 0 && -1 === n.indexOf(l)))
            for (var u = 0; u < l.inboundLayers.length; ++u) {
...
function execute(e, t, n, r) {
    for (var i = null != n && n.training, a = Array.isArray(e), o = a ? e : [e], s = o.map(function(e) {
        ...
        var h = p[c]; - 1 !== u.indexOf(h) ? l.push(t.getValue(h)) : l.push(null)
    }
    ...
    for (var y = new FeedDict(t), v = 0; v < d.length; ++v) {
        ...
        if (!(z instanceof InputLayer)) {
            ...
            for (var D = getNodeOutputs(w), O = Array.isArray(D) ? D : [D], R = 0; R < O.length; ++R) {
                ...
                var M = s.indexOf(O[R].name); - 1 !== M && (l[M] = L[R])
            }
            i || dispose(_)
        }
    }
...
function getTopologicalSortAndRecipientCounts(e, t) {
    ...
    if (1 === e.length) {
        ...
        for (var a = new Set, o = 0, s = e; o < s.length; o++) {
                                ...
                                case 1:
                                    return t = s.sent(), a = tidy(function() {
                                        if (t.value) {
                                            ...
                                            if (dispose(s), 0 === u)
                                                for (var p = 0; p < c.length; ++p) a.push(scalar(0));
                                            var h = s[0].shape[0],
                                                d = function(e) {
                                                    var t = c[e],
                                                        n = a[e];
...
function disposeNewTensors(e, t) {
    if (null != e) {
        var n = [];
        if (t instanceof Tensor) n.push(t.id);
        ...
        var a = [];
        if (e instanceof Tensor) - 1 === n.indexOf(e.id) && a.push(e);
        else if (Array.isArray(e)) e.forEach(function(e) {
            -1 === n.indexOf(e.id) && a.push(e)
        });
        else if (null != e)
            for (var o in e) {
                var s = e[o]; - 1 === n.indexOf(s.id) && a.push(s)
            }
...
function checkLossAndTargetCompatibility(e, t, n) {
    for (var r = [meanSquaredError, binaryCrossentropy, categoricalCrossentropy], i = 0; i < e.length; ++i) {
        ...
        if (null != o) {
            ...
            if (-1 !== r.indexOf(o))
                for (var l = a.shape.slice(1), u = s.slice(1), c = 0; c < l.length; ++c) {
                    var p = l[c],
                        h = u[c];
...
var LAYERS_MODEL_FORMAT_NAME = "layers-model",
    LayersModel = function(e) {
        ...
        return __extends(t, e), t.prototype.summary = function(e, t, n) {
            ...
            var t = this;
            if (null == e.loss && (e.loss = []), this.loss = e.loss, "string" == typeof e.optimizer) this.optimizer_ = getOptimizer(e.optimizer), this.isOptimizerOwned = !0;
            else {
            ...
            if (e instanceof Tensor && (e = [e]), Array.isArray(e)) {
                ...
                for (var s = 0, l = this.inputs; s < l.length; s++) {
                    var u = l[s],
                        c = e[u.name];
                ...
                for (var a = makeBatches(i, t), o = r.outputs.map(function(e) {
                        ...
                        tidy(function() {
                            var n = a[t][0],
                                ...
                                s = [];
                            if (Array.isArray(o))
                                for (var l = 0; l < o.length; ++l) s.push({
                                    key: r.inputs[l],
                                    value: o[l]
                                });
                            else s.push({
            ...
            return void 0 === r && (r = 0), tidy(function() {
                ...
                for (var l = makeBatches(o, n), u = tensor1d(range(0, o)), c = 0; c < l.length; ++c) {
                    var p = l[c][0],
                        ...
                        g = e(f);
                    if (0 === c)
                        for (var m = 0; m < g.length; ++m) s.push(scalar(0));
            ...
            return function(t) {
                ...
                return [e.optimizer_.minimize(function() {
                    ...
                    for (s = 0; s < e.metricsTensors.length; ++s) {
                        var d = void 0;
                        if (e.outputs.length > 1 && s < e.outputs.length) d = n[s];
                        else {
            ...
            var e;
            if ("string" == typeof this.loss) e = toSnakeCase(this.loss);
            ...
            var t, n, r = deserialize(convertPythonicToTs(e.optimizer_config));
            if ("string" == typeof e.loss) t = toCamelCase(e.loss);
            else if (Array.isArray(e.loss)) t = e.loss.map(function(e) {
                return toCamelCase(e)
            });
            else if (null != e.loss)
                for (var i in t = {}, e.loss) t[i] = toCamelCase(e.loss[i]);
            if (Array.isArray(e.metrics)) n = e.metrics.map(function(e) {
                return toCamelCase(e)
            });
            else if (null != e.metrics)
                for (var i in n = {}, e.metrics) n[i] = toCamelCase(e.metrics[i]);
            this.compile({
                loss: t,
                metrics: n,
                optimizer: r
    ...
    return __awaiter(this, void 0, void 0, function() {
        ...
        return __generator(this, function(r) {
            if (null == t && (t = {}), "string" == typeof e) {
                if (0 === (n = io.getLoadHandlers(e, t.onProgress)).length) n.push(io.browserHTTPRequest(e, t));
...
var Sequential = function(e) {
    function t(t) {
        ...
        if (t = t || {}, n.trainable = !0, n.built = !1, n.name = null != t.name ? t.name : getUid("sequential_"), null != t.layers)
            for (var r = 0, i = t.layers; r < i.length; r++) {
                var a = i[r];
                n.add(a)
            }
        return n
    ...
    return __extends(t, e), t.prototype.checkShape = function(e) {
        ...
        var n, r = e instanceof t || e instanceof LayersModel;
        if (r) {
...
var PReLU = function(e) {
    function t(t) {
        var n = e.call(this, null == t ? {} : t) || this;
        if (n.DEFAULT_ALPHA_INITIALIZER = "zeros", null == t && (t = {}), n.supportsMasking = !0, n.alphaInitializer = getInitializer(t.alphaInitializer || n.DEFAULT_ALPHA_INITIALIZER), n.alphaRegularizer = getRegularizer(t.alphaRegularizer), n.alphaConstraint = getConstraint(t.alphaConstraint), null == t.sharedAxes) n.sharedAxes = null;
    ...
    return __extends(t, e), t.prototype.build = function(e) {
        ...
        var i = {};
        if (null != this.sharedAxes)
            for (var a = 1; a < e.length; ++a) i[a] = e[a];
...
function batchDot(e, t, n) {
    ...
    return tidy(function() {
        ...
        if (2 === e.shape.length && 2 === t.shape.length) o = a[0] === a[1] ? e.mulStrict(t).sum(a[0]) : e.transpose([1, 0]).mulStrict(t).sum(a[1]);
        else {
...
function batchNormalization(e, t, n, r, i, a) {
    var o;
    if (void 0 === a && (a = .001), 2 === e.rank) o = batchNorm2d(e, t, n, r, i, a);
    else if (3 === e.rank) o = batchNorm3d(e, t, n, r, i, a);
    else {
...
var ZeroPadding2D = function(e) {
    function t(t) {
        var n = this;
        if (null == t && (t = {}), (n = e.call(this, t) || this).dataFormat = null == t.dataFormat ? imageDataFormat() : t.dataFormat, null == t.padding) n.padding = [
            [1, 1],
            [1, 1]
        ];
            ...
            var r = void 0,
                i = void 0;
            if ("number" == typeof t.padding[0]) r = [t.padding[0], t.padding[0]], i = [t.padding[1], t.padding[1]];
            else {
    ...
    return __extends(t, e), t.prototype.getStates = function() {
        ...
        void 0 === t && (t = !1), tidy(function() {
            ...
            if (null == n.states_) Array.isArray(n.cell.stateSize) ? n.states_ = n.cell.stateSize.map(function(e) {
                return zeros([r, e])
            }) : n.states_ = [zeros([r, n.cell.stateSize])];
            else if (null == e) dispose(n.states_), null != n.keptStates && (dispose(n.keptStates), n.keptStates = []), Array.isArray(n.cell.stateSize) ? n.states_ = n.cell.stateSize.map(function(e) {
                return zeros([r, e])
            }) : n.states_[0] = zeros([r, n.cell.stateSize]);
            else {
...
var StackedRNNCells = function(e) {
    ...
    return __extends(t, e), Object.defineProperty(t.prototype, "stateSize", {
        ...
        for (var t = [], n = 0, r = this.cells; n < r.length; n++)
            for (var i = r[n], a = i.weights.length, o = e.splice(a), s = 0; s < i.weights.length; ++s) t.push([i.weights[s], o[s]]);
        batchSetValue(t)
