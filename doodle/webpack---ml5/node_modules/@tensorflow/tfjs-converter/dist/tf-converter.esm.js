    ...
    executeOp$13 = function(e, t, a) {
        switch (e.op) {
            ...
            case "StridedSlice":
                ...
                if (1 === u.length && h.shape.length > 1)
                    for (var N = 1; N < h.shape.length; N++) u.push(0), m.push(h.shape[N]), l.push(l[0]);
...
var GraphExecutor = function() {
    ...
    GraphModel = function() {
        ...
        return Object.defineProperty(e.prototype, "modelVersion", {
            ...
            else if (null != this.loadOptions.requestInit) this.handler = io.browserHTTPRequest(e, this.loadOptions);
            else {
                var t = io.getLoadHandlers(e, this.loadOptions.onProgress);
                if (0 === t.length) t.push(io.browserHTTPRequest(e, this.loadOptions));
