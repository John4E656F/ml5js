        ...
        if (values) {
            ...
            set = function(t) {
                for (var i = 0, k = 0, j, v; i < n; ++i) {
                    ...
                    if (v == null)
                        for (j = 0; j < m; ++j, ++k) t[as[k]] = defaultValue;
                    else
                        for (j = 0; j < m; ++j, ++k) t[as[k]] = values[j](v);
                }
            };
        } else {
            if (!as) {
...
function cell(measures, counts, countOnly) {
    ...
    cell.set = function(t) {
        ...
        if (!countOnly)
            for (i = 0, n = a.length; i < n; ++i) a[i].set(t);
    };
